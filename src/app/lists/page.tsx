...
import Navbar from '@/components/Navbar'; // <--- 1. Импорт Navbar
...
export default async function ListsPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#050505] text-white pt-24 px-6"> {/* 3. Увеличил отступ до pt-24 для надежности */}
